...
#            print(k,v)
    ...
    stationName = str(parsed_result["data"][0]["stationName"])
    measuretime = str(parsed_result["data"][0]["observations"][0]["time"])
    waterlevel = str(parsed_result["data"][0]["observations"][0]["value"])
    waterlevelunit = str(parsed_result["data"][0]["unit"])
    waterflow = str(parsed_result["data"][1]["observations"][0]["value"])
    waterflowunit = str(parsed_result["data"][1]["unit"])

    print(Fore.GREEN + stationName + " " + measuretime + " " + waterlevel + " " + waterlevelunit + " " + waterflow + " " + waterflowunit)
    print(Style.RESET_ALL)    
